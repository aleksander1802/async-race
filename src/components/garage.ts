...
export function createGarageItem(item: ICar) { 
  ...
  elem.innerHTML = `
        <div class="garage__item_wrapper">
          <button class="button garage__item_wrapper-selectBtn">Select</button>
          <button class="button garage__item_wrapper-removeBtn">Remove</button>
          <div class="garage__item_wrapper-name">${item.name}</div>
        </div>          
        <div class="garage__item_config">
          <div class="garage__item_config-btns">
          <button class="button garage__item_config-startBtn">A</button>
          <button class="button garage__item_config-resetBtn">B</button>
          </div>            
